...
csv.field_size_limit(100000000) # set the field size limit to 1MB
...
def process_files(csv_file, data_root, num_workers):
    ...
    def process(x):
        ...
        if '.wav' not in file_name:
          ...
          output_wav_path = os.path.join(wav_dir, file_name )
    ...
    if not os.path.isdir(folder_path):
        ...
        if not os.path.isdir(folder_path):
            ...
            if not os.path.isdir(folder_path):
                ...
                sys.exit()
    """
    folder_path = 'unpack'+ f'/{args.language}/'
    print('args.files_to_process', args.files_to_process)
    print('args.args.num_workers', args.num_workers)
