...
def extract_features(
    ...
    qq=0;
    for filenamesx in allframe_test_chunk:
      qq+=1
      print('################### extract feature ###################')

      dataset = utils.ImagesDataset(filenames=filenamesx, images_root=images_root, transform=val_transform)
...
def extract_eigx(filenames,data_dict,K,which_matrix,which_features,normalize,lapnorm,which_color_matrix,threshold_at_zero,image_downsample_factor,image_color_lambda):
