...
class dataloader(keras.utils.Sequence):
    ...
    def __getitem__(self, idx):
        ...
        z = np.zeros((self.batch_size,) + self.img_size + (1,), dtype="float32")
        w = np.zeros((self.batch_size,) + self.img_size + (1,), dtype="float32")
        t = np.zeros((self.batch_size,) + self.img_size + (1,), dtype="float32")
