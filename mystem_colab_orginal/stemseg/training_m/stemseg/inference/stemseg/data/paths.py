...
class YoutubeVISPaths(object):
    ...
    @staticmethod
    def val_base_dir():
        return os.path.join(_get_env_var('/home/kasaei/FarnooshArefi/STEm-Seg/orginal/STEm-Seg/'), 'valid')
    ...
    @staticmethod
    def val_vds_file():
        return os.path.join(_get_env_var('/home/kasaei/FarnooshArefi/STEm-Seg/orginal/STEm-Seg/'), 'youtube_vis_val.json')
